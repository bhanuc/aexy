...
export const DASHBOARD_WIDGETS: Record<string, WidgetDefinition> = {
  ...
  teamStatsSummary: {
    ...
    defaultSize: 'large',
    icon: 'Users',
    description: 'Team commits, PRs, reviews, and lines changed',
    requiredPermissions: ['can_view_teams'],
  },
  tasksCompletedChart: {
    ...
    defaultSize: 'medium',
    icon: 'CheckSquare',
    description: 'Completed story points per sprint',
    requiredPermissions: ['can_view_sprints'],
  },
  ticketChart: {
    id: 'ticketChart',
    ...
    defaultSize: 'medium',
    icon: 'Ticket',
    description: 'Tickets by status with SLA badge',
    requiredPermissions: ['can_view_tickets'],
  },
  velocityTrend: {
    id: 'velocityTrend',
    ...
    defaultSize: 'medium',
    icon: 'TrendingUp',
    description: 'Committed vs completed over sprints',
    requiredPermissions: ['can_view_sprints'],
  },
  workloadDistribution: {
    ...
    defaultSize: 'medium',
    icon: 'BarChart3',
    description: 'Workload per team member',
    requiredPermissions: ['can_view_teams'],
  },
  backlogOverview: {
    id: 'backlogOverview',
    ...
    defaultSize: 'medium',
    icon: 'Layers',
    description: 'Story status breakdown and points progress',
    requiredPermissions: ['can_view_sprints'],
  },
  ticketPipeline: {
    id: 'ticketPipeline',
    ...
    defaultSize: 'medium',
    icon: 'GitPullRequest',
    description: 'Compact ticket pipeline by status and priority',
    requiredPermissions: ['can_view_tickets'],
  },
};
