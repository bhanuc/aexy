...
// inherited 'GTM Intelligence' from its module layout, which 22 routes share, so the
...
export const metadata: Metadata = { title: { default: "Scoring & ICP", template: "%s · Scoring & ICP | Aexy" } };
