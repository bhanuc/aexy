...
// "Email marketing", not "Settings": the parent settings layout's template is
// `%s · Settings | Aexy`, so a page titled "Settings" rendered the tab as
// "Settings · Settings | Aexy".
