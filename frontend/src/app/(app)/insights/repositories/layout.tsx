...
// inherited 'Insights' from its module layout, which 14 routes share, so the
...
export const metadata: Metadata = { title: { default: "Repositories", template: "%s · Repositories | Aexy" } };
