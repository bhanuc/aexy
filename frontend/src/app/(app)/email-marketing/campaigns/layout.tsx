...
// inherited 'Email Marketing' from its module layout, which 7 routes share, so the
...
export const metadata: Metadata = { title: { default: "Campaigns", template: "%s · Campaigns | Aexy" } };
