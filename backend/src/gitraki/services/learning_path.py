...
from gitraki.llm.base import AnalysisType
...
from gitraki.models.career import CareerRole, LearningMilestone, LearningPath
...
class LearningPathService:
    ...
    async def _generate_path_with_llm(
        ...
        try:
            from gitraki.llm.base import AnalysisRequest
